...
| **DreamPath (광고 기반)** | **1개월** | **무료** | 적성검사 + 커리어 패스 + AI 멘토 + 실행 기록 포트폴리오 |
| **DreamPath 1년** | **12개월** | **무료** | 구글 애드센스 광고 + 학교 B2B 프라이버시 공간 제공 수익 (구독료 없음) |
...
2. 아들(고1)에게 DreamPath 사용 추천 (무료, 광고 기반)
...
│  ─────────────────────────────────                              │
│  · 드림북은 별도 제품이 아니라, 앱 내 계획+Todo 실행 기록의 결과물이다. │
...
| 원칙 | 설명 |
|------|------|
| **드림북 분리 없음** | 드림북은 별도 기능이 아니라, 계획+Todo 실행 데이터가 자동 정리된 결과물 |
