...
const GLOSSARY: Record<string, GlossaryEntry> = {
  ...
  // ── 2027 대입 대전환 (등록금 0원 · AI · 창업/기업연계) ──────────────
  'LINC 3.0': { full: '3단계 산학연협력 선도(전문)대학 육성사업', meaning: '교육부가 대학·기업을 붙여주는 사업. 캡스톤디자인·PSP·현장실습이 이 예산으로 운영됨 (2022~2028)', emoji: '🏭' },
  'IPP': { full: 'Industry Professional Practice', meaning: '기업연계형 장기현장실습. 학기 중 4~6개월 기업 근무를 학점으로 인정', emoji: '🛠️' },
  '캡스톤디자인': { full: 'Capstone Design', meaning: '기업이 낸 실제 과제를 팀으로 한 학기~1년간 해결하는 졸업 프로젝트 교과목', emoji: '🎓' },
  'PSP': { full: 'Problem-Solving Project', meaning: 'LINC 3.0의 문제해결형 프로젝트 교과. 기업 현장 문제를 학생 팀이 해결', emoji: '🧩' },
  'AX': { full: 'AI Transformation', meaning: 'AI 대전환. 기존 산업·업무에 AI를 접목해 바꾸는 것. 2026 정부 예산 2.4조', emoji: '🔄' },
  'URP': { full: 'Undergraduate Research Program', meaning: '학부연구생 제도. 학부생이 교수 연구실에 들어가 연구에 참여', emoji: '🔬' },
  '계약학과': { full: '채용조건형 계약학과', meaning: '기업과 대학이 계약해 별도 선발. 4년 전액장학+생활비, 졸업 시 채용 확정, 의무복무 있음', emoji: '🏢' },
  '예비창업패키지': { full: '예비창업패키지', meaning: '사업자등록 전 예비창업자 지원. 평균 0.4억, 자기부담금 없음. 2026년 300명', emoji: '🌱' },
  '초기창업패키지': { full: '초기창업패키지', meaning: '창업 3년 이내 기업 지원. 최대 1억. 본점 소재지 권역 내에서만 신청 가능', emoji: '🚀' },
  '창업중심대학': { full: '창업중심대학', meaning: '중기부가 지정한 대학. 예비→초기→도약을 한 대학에서 연속 지원. 최대 1.5억', emoji: '🏫' },
  '캠퍼스타운': { full: '서울시 캠퍼스타운', meaning: '서울시가 13개 대학에 창업 공간·멘토링·초기자금을 지원하는 사업', emoji: '🏙️' },
  '창업휴학': { full: '창업휴학', meaning: '창업을 이유로 하는 휴학. 대학별로 최대 2년까지 사용 가능', emoji: '⏸️' },
  '창업대체학점': { full: '창업대체학점(창업현장실습)', meaning: '사업자등록 후 창업활동을 학점으로 인정. 학기당 6~12학점', emoji: '📗' },
  '거점국립대': { full: '국가거점국립대학교', meaning: '강원·경북·경상국립·부산·전남·전북·제주·충남·충북대 9곳(+서울대)', emoji: '🏛️' },
  'AI중심대학': { full: 'AI중심대학', meaning: '과기정통부 사업. 전국 10개교에 연 30억×최대 8년(총 240억) 지원', emoji: '🤖' },
  'AI 거점대학': { full: 'AI 거점대학', meaning: '교육부 사업. 지방 거점국립대 3교(부산대·전남대·충남대)에 교당 1,000억 원 내외', emoji: '📡' },
  '글로컬대학': { full: '글로컬대학30', meaning: '교육부가 지역 대학을 선정해 5년간 1,000억 원을 지원하는 사업', emoji: '🌐' },
  '지역인재전형': { full: '지역인재전형', meaning: '해당 지역 고교 졸업자를 우대 선발하는 전형. 거점국립대·지방 의대가 운영', emoji: '🏘️' },
