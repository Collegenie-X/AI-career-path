...
export const LABELS = {
  ...
  star_ai_orchestra_title: 'AI 오케스트라 : 지금 바뀌는 역할',
  star_orchestra_role_shift_label: '역할 이동',
  star_orchestra_from_label: '예전',
  star_orchestra_to_label: '지금~2032',
  star_orchestra_tool_label: '지금 익혀야 할 AI 스택',
  star_orchestra_watch_label: '지금 주목할 변화',
  star_orchestra_routine_label: 'AI 오케스트레이션 루틴',
  star_venture2032_title: '2032 창직 프로젝트',
  star_venture_thesis_label: '왜 창직인가',
  star_venture_skills_label: 'AI 시대 필수 역량',
  star_venture_time_note_label: '먼저 알아둘 것 — 시간 배분',
  star_venture_tracks_label: '내 학교 유형별 실행 트랙',
  star_venture_track_when_label: '언제',
  star_venture_track_load_label: '주당 투입',
  star_venture_projects_label: '단계별 실행 프로젝트',
  star_venture_timing_label: '시기',
  star_venture_load_label: '투입',
  star_venture_problem_label: '풀 문제',
  star_venture_steps_label: '실행 단계',
  star_venture_stack_label: 'AI·도구',
  star_venture_deliverable_label: '산출물',
  star_venture_proof_label: '검증 지표',
  star_venture_revenue_label: '수익화 경로',
  star_venture_duration_label: '기간',
  star_venture_cost_label: '예산',
  star_venture_solo_path_label: '1인 스튜디오 로드맵',
  modal_project_tab: '프로젝트',
  modal_future2032_tab: '2032',
  future2032_badge: '2032년 현재',
  future2032_empty: '이 직업의 2032년 데이터를 준비 중입니다.',
  future2032_shift_label: '역할 이동',
  future2032_from_label: '2020년대 초',
  future2032_to_label: '2032년',
  future2032_skills_label: 'AI 시대 필수 역량',
  future2032_train_label: '지금 훈련법',
  future2032_tools_label: '실제로 쓰는 AI 도구',
  future2032_fading_label: 'AI가 가져간 일',
  future2032_moat_label: '사람 몫으로 남은 일',
  future2032_new_roles_label: '2032년에 새로 생긴 역할',
  future2032_start_now_label: '중·고등학생이 지금 시작할 것',
  future2032_day_note: '2032년 시나리오는 현재 기술 흐름을 바탕으로 한 예측입니다. 실제 일과는 회사·팀에 따라 다릅니다.',
  project_track_why_label: '왜 프로젝트로 하나요',
  project_track_stack_label: '이 직업의 기본 제작 라인',
  project_track_mission_label: '이 프로젝트의 목표',
  project_track_steps_label: '실행 단계',
  project_track_stack_item_label: '쓰는 도구',
  project_track_deliverable_label: '산출물',
  project_track_proof_label: '완료 판정 기준',
  project_track_record_label: '기록·활용',
  project_track_duration_label: '기간',
  project_track_cost_label: '예산',
  project_track_count_suffix: '단계 프로젝트',
