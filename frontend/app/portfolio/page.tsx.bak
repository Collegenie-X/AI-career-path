      ...
      <div className="px-4 py-6 pb-32 space-y-4">
        ...
        {activeTab === 'badges' && (
          <div className="space-y-4">
            <div className="glass-card p-5">
              <h3 className="font-bold text-lg mb-1">획득한 배지</h3>
              <p className="text-sm text-muted-foreground mb-4">
                {earnedBadges.length}/{badges.length}개 수집 완료
              </p>
              <div className="grid grid-cols-2 gap-3">
                  ...
                  return (
                    <div
                      ...
                      className={`relative rounded-xl p-4 text-center transition-all ${
                        earned 
                          ? 'glass-card border-2 border-primary/30 animate-scale-bounce' 
                    ...
                    >
                      ...
                      <div className={`w-16 h-16 mx-auto mb-3 rounded-full flex items-center justify-center text-3xl bg-gradient-to-br ${rarityColors[badge.rarity as keyof typeof rarityColors]}`}>
                        {badge.icon === 'Sparkles' ? '✨' :
                         badge.icon === 'Heart' ? '❤️' :
                         badge.icon === 'MapPin' ? '📍' :
                         badge.icon === 'Compass' ? '🧭' :
                      ...
                      <div className="space-y-1">
                        <div className={`inline-block px-2 py-1 rounded-full text-xs font-semibold ${
                          badge.rarity === 'legend' ? 'bg-yellow-500/20 text-yellow-300' :
