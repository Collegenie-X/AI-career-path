                    ...
                    <div key={year.gradeId} className="relative pl-12 pb-6">
                      ...
                      <div className="space-y-2.5 pt-1">
                        <div>
                          ...
                          <div className="text-[11px] text-gray-500">{year.items.length}개 항목</div>
                        </div>
                            ...
                            {year.goals.map((goal, gi) => (
                              ...
                              >
                                <div
                                  ...
                                  style={{ backgroundColor: template.starColor }}
                                />
                        ...
                        {year.items.length > 0 && (
                          <div className="space-y-1.5">
                            ...
                            {year.items.map((item) => {
                              ...
                              const monthLabel = typeof rawItem.month === 'number'
                                ? `${rawItem.month}월`
                                : Array.isArray(rawItem.months)
                                  ? (rawItem.months as number[]).length === 1
                                    ? `${(rawItem.months as number[])[0]}월`
                                    : `${(rawItem.months as number[])[0]}~${(rawItem.months as number[])[(rawItem.months as number[]).length - 1]}월`
                                  : '월 미정';
