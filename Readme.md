...
> 중학생~고등학생 AI 커리어 패스 설계 + 고입 탐색 + 모임 활성화 플랫폼  
...
### 2. 고입 탐색 (HighSchool Admission Tab)
...
DreamPath    ████████████████████████████████████████████████████
              클릭 → 나만의 계획 → 고입 탐색 → 런치패드 모임 → 지속 성장 (전 구간 유일)
```
...
| **핵심 차별점** | 클릭 한 번 커리어 패스 생성 + 고입 탐색 + 런치패드 모임 (시장 유일) |
...
│   │   │           │   ├── index.tsx             # 메인 (JSON 조립)
│   │   │           │   ├── PlanetOrbitView.tsx   # 행성 궤도 뷰
│   │   │           │   ├── SchoolCategoryView.tsx
│   │   │           │   ├── SchoolDetailModal.tsx # 학교 상세 다이얼로그
│   │   │           │   ├── AptitudeCheckSection.tsx
│   │   │           │   ├── IdentityMentalSection.tsx
│   │   │           │   ├── CategoryTraitDetailDialog.tsx
│   │   │           │   ├── DecisionFlowCard.tsx
│   │   │           │   ├── SchoolTypeCard.tsx
│   │   │           │   └── category-trait-detail-config.ts
...
│   │   │   ├── meta.json              # 전역 메타·적성 체크리스트·정체성 팁
│   │   │   ├── science_high.json      # 과학고·영재고
│   │   │   ├── foreign_language.json  # 외국어고
│   │   │   ├── international.json     # 국제고
│   │   │   ├── ib.json                # IB 인증학교 (신규)
│   │   │   ├── autonomous_private.json # 자율형사립고
│   │   │   ├── autonomous_public.json  # 자율형공립고
│   │   │   ├── arts_sports.json       # 예술고·체육고
│   │   │   ├── meister.json           # 마이스터고
│   │   │   ├── business.json          # 비즈니스고
│   │   │   └── general_elite.json     # 일반고 (학군지)
...
│
├── documents/                         # 기획·리서치 문서
│   ├── 한국_캐리어패스_상_특목고_좋은대학_좋은직장_완전가이드.md
│   ├── 한국_캐리어패스_하_특목고_좋은대학_좋은직장_완전가이드_하.md
│   ├── 한국_캐리어패스_일반루트_특수루트_상세예시.md
│   ├── 커리어패스_20대_우수사례_벤치마킹_v2.md
│   └── 학교 진로 교육-AI시대_청소년_진로교육_가이드.md
│
└── Readme.md                          # 이 파일
```
...
- [x] XP / 레벨 시스템
- [x] 설정 페이지
- [x] **고입 탐색 (HighSchool Admission Tab)** ← 신규
