...
`docs/` 폴더는 아래 5개 카테고리로 정리되어 있습니다.

### 기획 (`docs/기획/`)
| 문서 | 내용 |
|------|------|
| [`INVESTMENT_PROPOSAL.md`](기획/INVESTMENT_PROPOSAL.md) | 투자 제안서 (시장, 수익 모델, 재무 전망, 페르소나) |
| [`COMPETITOR_ANALYSIS.md`](기획/COMPETITOR_ANALYSIS.md) | 경쟁사 분석 |
| [`PROJECT_BUILDER_DESIGN.md`](기획/PROJECT_BUILDER_DESIGN.md) | 프로젝트 빌더(캡컷식) 설계안 |
| [`(기획)-미네르바_5가지관점_프로젝트기획.md`](기획/(기획)-미네르바_5가지관점_프로젝트기획.md) | 미네르바 5 Lenses 분석법 해설 |
| [`(기획)-미네르바_5가지관점_실전편.md`](기획/(기획)-미네르바_5가지관점_실전편.md) | 미네르바 5 Lenses 실전 적용 로드맵 |
| [`(기획)-인문학6분야_기획자_심화가이드.md`](기획/(기획)-인문학6분야_기획자_심화가이드.md) | 인문학 6분야 기획자용 심화가이드 |

### 가이드 - 입시 (`docs/가이드-입시/`)
| 문서 | 내용 |
|------|------|
| [`2028_대입준비_완벽가이드.md`](가이드-입시/2028_대입준비_완벽가이드.md) | 2028 대입 전략 전체 개괄 |
| [`2028_학년별_대입준비_실전가이드.md`](가이드-입시/2028_학년별_대입준비_실전가이드.md) | 2028 대입 학년별(고1-3) 실전 대응 가이드 |
| [`고등학교_유형_완전정리_진로지도가이드.md`](가이드-입시/고등학교_유형_완전정리_진로지도가이드.md) | 고등학교 유형별 진로지도 상세가이드 |
| [`한국_고등학교_종류_완전정리.md`](가이드-입시/한국_고등학교_종류_완전정리.md) | 한국 고등학교 체계 완전정리 (자매 문서) |
| [`고입정보사이트_활용_교사레퍼런스.md`](가이드-입시/고입정보사이트_활용_교사레퍼런스.md) | 고입정보포털·학교알리미 활용 교사 레퍼런스 |
| [`대회_캠프_봉사_전시회_정리.md`](가이드-입시/대회_캠프_봉사_전시회_정리.md) | 비교과 활동(봉사·캠프·대회·전시회) 종합가이드 |
| [`(대입)-2032_대입예측_입학사정관_상담가이드.md`](가이드-입시/(대입)-2032_대입예측_입학사정관_상담가이드.md) | 2032 대입 예측 및 입학사정관 상담가이드 |
| [`(IB)-입학사정관_완전가인드.md`](가이드-입시/(IB)-입학사정관_완전가인드.md) | IB 입학사정관 완전가이드 |
| [`(IB)_한국_공교육_IB_도입_현황_2026.md`](가이드-입시/(IB)_한국_공교육_IB_도입_현황_2026.md) | 한국 공교육 IB 도입 현황 (2026) |
| [`(KB)_한국_공교육_KB_도입_현황_2026.md`](가이드-입시/(KB)_한국_공교육_KB_도입_현황_2026.md) | 한국 공교육 KB(한국형 바칼로레아) 도입 현황 (2026) |
| [`(KB교육)-한국형_바칼로레아_KB_완전가이드_2032대입전망.md`](가이드-입시/(KB교육)-한국형_바칼로레아_KB_완전가이드_2032대입전망.md) | 한국형 바칼로레아(KB) 완전가이드 및 2032 대입 전망 |
| [`(자율형공립고)-AI시대_자율형공립고_완전가이드_입학사정관용.md`](가이드-입시/(자율형공립고)-AI시대_자율형공립고_완전가이드_입학사정관용.md) | 자율형공립고 완전가이드 (입학사정관용) |
| [`(자율형사립고)-AI시대_자율형사립고_완전가이드_입학사정관용.md`](가이드-입시/(자율형사립고)-AI시대_자율형사립고_완전가이드_입학사정관용.md) | 자율형사립고 완전가이드 (입학사정관용) |

### 가이드 - 기술 (`docs/가이드-기술/`)
| 문서 | 내용 |
|------|------|
| [`AUTH_GUIDE.md`](가이드-기술/AUTH_GUIDE.md) | 이메일/소셜 로그인 인증 시스템 가이드 |
| [`LEGAL_PAGES_IMPLEMENTATION.md`](가이드-기술/LEGAL_PAGES_IMPLEMENTATION.md) | 이용약관/개인정보처리방침 등 법적 페이지 구현 요약 |
| [`TESTING_GUIDE.md`](가이드-기술/TESTING_GUIDE.md) | 커리어패스 백엔드 통합 테스트 가이드 |

### 변경이력 (`docs/변경이력/`)
| 문서 | 내용 |
|------|------|
| [`CAREER_PATH_UPDATES.md`](변경이력/CAREER_PATH_UPDATES.md) | 커리어패스 기능 업데이트 내역 |
| [`CHANGELOG_2026-03-27.md`](변경이력/CHANGELOG_2026-03-27.md) | 프론트-백엔드 커리어패스 통합 변경이력 |
| [`CHANGELOG_CAREER_PATH.md`](변경이력/CHANGELOG_CAREER_PATH.md) | 커리어패스 중심 개편 완료 보고 (2026-02-27) |
| [`FINAL_UPDATES.md`](변경이력/FINAL_UPDATES.md) | DreamPath 과정중심 철학 정립 최종 업데이트 |
| [`INTEGRATION_SUMMARY.md`](변경이력/INTEGRATION_SUMMARY.md) | 프론트-백엔드 커리어패스 통합 요약 |

### 참고자료 (`docs/참고자료/`)
| 문서 | 내용 |
|------|------|
| [`생기부ON_샘플리포트.pdf`](참고자료/생기부ON_샘플리포트.pdf) | 생기부ON 샘플 리포트 |

> `documents/` 폴더(레포 루트, `docs/`와 별개)에는 특목고·좋은대학·좋은직장 완전가이드(상/하)가 있습니다. `frontend/docs/`에는 SITEMAP.md, BADGE_SYSTEM.md, CHANGES_SUMMARY.md 등 프론트엔드 전용 기술 문서가 있습니다.
