...
import { Building2, ExternalLink, CheckCircle2, XCircle, Info, BookOpen, Target, Rocket, Trophy, Calendar, ChevronDown } from 'lucide-react';
            ...
            <>
              ...
              <div className="rounded-lg p-3 bg-white/5 border border-white/10">
                ...
                <div className="space-y-2">
                  ...
                  <InfoRow label="선발 과정" value={institution.admissionProcess} />
                      ...
                      >
                        ...
                        {isOpen && (
                          <div className="p-3 space-y-2" style={{ background: 'rgba(15,23,42,0.5)' }}>
                            <div>
                              <p className="text-[10px] font-bold uppercase tracking-wider mb-1" style={{ color: institution.color }}>
                                타임라인
                              </p>
                              <p className="text-xs text-white/85">{example.timeline}</p>
                            </div>
                            <div>
                              <p className="text-[10px] font-bold uppercase tracking-wider mb-1.5" style={{ color: institution.color }}>
                                핵심 성공 요인
                              </p>
                              <div className="space-y-1">
                            ...
                            <div>
                              ...
                              <div className="space-y-1">
                                {strategy.monthlyActions.map((action, idx) => (
                                  <div key={idx} className="flex items-start gap-2 text-xs text-white/85">
                                    <span className="inline-block w-1.5 h-1.5 rounded-full mt-1.5 flex-shrink-0" style={{ background: institution.color }} />
                                    <span>{action}</span>
                                  </div>
                                ))}
                              </div>
